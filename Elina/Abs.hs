...
-- | The abstract syntax of language Elina.

module Elina.Abs where
...
data Stmt' a
    ...
    | Break a
    | Continue a
    | AssTuple a [TupleIdent' a] (Expr' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type TupleIdent = TupleIdent' BNFC'Position
data TupleIdent' a
    = TupleIdent a Ident | TupleIdentNested a [TupleIdent' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Type = Type' BNFC'Position
data Type' a = Int a | Str a | Bool a | Void a | Tuple a [Type' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
